...
<body>
 ...
 ?>
						<img src="images/leo.png" alt=" " class="img-responsive" width="100" height="100"/>
<h3 style="padding-top: 0px">Leo</h3>
<h4 style="padding-top: 10px"><?php 
include('simple_html_dom.php');
$html = file_get_html('https://www.prokerala.com/astrology/horoscope/?sign=leo');
